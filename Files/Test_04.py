...
def func_get_data_by_crime_type(dtfrm, type, chart, year, city):
    ...
    if chart == "bar":
        show_bar_chart(dtframe_for_crime_type, 'Months', 'Number of Crimes', city +' - Crime Report '+year+' - ' + type, 0.2, 0.8, 0)
    elif chart == "pie":
        ...
        x = month_array_2
        y = plt_sequence
        show_line_chart(1, x, y, 'Months', 'Number of Crimes',  city +' - Crime Report '+year+' - '  + type, type, 0.2, 0.8, 0)
...
def func_get_data_by_all_crimes_vs_month(dtfrm, chart, year, city):
    ...
    if chart == "bar":
        show_bar_chart(dtframe_for_month, 'Months', 'Number of Crimes', city + ' - Crime Report '+year+' - Monthly Crime Frequency', 0.2, 0.8, 45)
    elif chart == "line":
        ...
        x = month_array_2
        y = transposed_arr
        show_line_chart(2, x, y, 'Months', 'Number of Crimes', city + ' - Crime Report '+year+' - Monthly Crime Frequency', index_array ,0.2, 0.8, 45)
...
def func_get_data_by_year(dtf_1, dtf_2, chart):
...
######################################################
def func_get_data_by_year_with_crime_type(dtf_1, dtf_2, type, chart):
...
def func_show_compare_chart(value):
    ...
    if selected_analyze_type == 'Crime type':
        ...
        else: func_get_data_by_year_with_crime_type(df_selcted_1, df_selcted_2, selected_crime, value)
    elif selected_analyze_type == 'month':
        func_get_data_by_year(df_selcted_1, df_selcted_2, value)
